    ...
    >
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input class="field" id="purchase_date" type="date" name="purchase_date" value="{{ old('purchase_date', now()->toDateString()) }}" required>
            </div>
            <div>
                <label class="field-label" for="reference">Supplier invoice / ref</label>
                <input class="field" id="reference" name="reference" value="{{ old('reference') }}">
            </div>
            <div class="full">
